...
모드를 선택하면 AI가 자료를 요청합니다. 준비한 폴더 경로를 알려주세요.

```
사용자: 참고자료는 ~/Desktop/지원사업/자료/ 에 있어
AI: [공고문 분석 중...] [서비스 소개서 분석 중...] [재무제표 분석 중...]
```

이후 AI가 알아서 Phase 1~5까지 진행합니다. 협업 모드면 중간중간 질문이 옵니다.
