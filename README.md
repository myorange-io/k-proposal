...
**있으면 좋은 것**: 서비스소개서, 이전 사업계획서, IR 자료, 수상이력, 고객사 계약서, 특허등록증, 팀원 이력서
...
파일탐색 → 공고/양식분석 → 회사자료분석 → 초안작성 → 휴먼라이징 → 심사위원 관점 검토 → 시각자료생성 → HWPX채우기 → 검토/제출
```
...
| 3.5 | AI 흔적 제거, 개조식 명사형 문체 전환 | 심사역이 AI 문체를 3초 만에 알아봄 |
| **3.6** | **심사위원 관점 모의 채점 + 킬러 질문 + 약점 개선** | **60점 미만 항목을 HWPX 채우기 전에 잡아냄** |
